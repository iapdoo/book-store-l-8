    ...
    <div class="container">
        <div class="row">
            ...
            <div class="price-option text-center">
                <div class="container">
                    <div class="row">
                        @foreach($product as $productDesc)
                            <div class="col-md-4">
                                <div class="price-box">
                                        ...
                                        <div id="demo" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="{{asset('storage/'.$productDesc->product_image)}}" alt="Los Angeles" width="200" height="200">
                                                </div>
                                            </div>
                                    ...
                                    <h2 class="product-name" style="margin: auto;">
                                        <a class="uppercase " href="show_product_details/{{$productDesc->id}}">{{app()->getLocale() == "ar" ?$productDesc->product_name_ar:$productDesc->product_name_en}} </a>
                                    </h2>
                                    <h1>${{$productDesc->product_price}}</h1>
                                </div>
                            </div>
                        @endforeach
