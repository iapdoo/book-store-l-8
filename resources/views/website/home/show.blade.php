        ...
        <div class="row">
            <div class="col-12">
                        <div class="word-rtl-category">
                            ...
                            <p>
                                {{app()->getLocale() == "ar" ?$categoryinfo->category_description_ar:$categoryinfo->category_description_en}}
                            </p>
                        </div>
                <!-- /.card -->
            </div>
                    ...
                    <div class="col-12 col-lg-10 mt-auto product-detail-cart-data">
                        <div class="media-body ml-lg-3">
                            <h4 class="product-name">
                                <a class="uppercase " href="{{url('show_product_details/'.$productinfo->id)}}"> {{app()->getLocale() == "ar" ?$productinfo->product_name_ar:$productinfo->product_name_en}} </a>
                            </h4>
                            <p class="product-des">{{app()->getLocale() == "ar" ?$productinfo->product_description_ar:$productinfo->product_description_en}}</p>
                        </div>
                    </div>
                </div>
            </div>
